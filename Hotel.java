...
public class Hotel implements Observer {
   ...
   for (Map.Entry<String, List<Room>> entry : rooms.entrySet()) {
    ...
    //the hotel can send notifications to the customers
      public void notifyObservers(String message, String date) {
      ...
      public void notifyMassege(String date) {
        Scanner scanner1 = new Scanner(System.in);

        System.out.println("Enter the massege you want to send to the customers:");
        String mes = scanner1.nextLine();
                notifyObservers(mes, date);
      }
    ...
    //  @Override
      //public void update(String message) {
        // Hotel might also be observable by other entities, handle message here
    //  }
