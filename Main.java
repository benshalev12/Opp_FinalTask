    ...
    public static void main(String[] args) {
       ...
       owner2.addRoomsToHotel("City Luxury", "etc", 6, 500.0, 2, true, true);
             ...
             while (run) {
                 ...
                 System.out.println("3. for new customer");
                 System.out.println("4. for new hotel owner");
                 ...
                 switch (choice) {
                     ...
                     case 2:
                        ...
                        System.out.println("Enter your id:");
                         ...
                         scanner.nextLine();
                         if ((id1<19999999)||(id1>1000000000))
                         { System.out.println("Invalid id. Please try again.");
                             break; }  
                        ...
                        OwnerHotel owner = new OwnerHotel(ownerName, id1, password1);
                        OwnerDatabase.getInstance().addOwner(owner);
                         break;
